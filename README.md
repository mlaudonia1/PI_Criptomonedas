...
En cuanto a Ripple, las noticia públicass dieron cuenta de que tuvo una victoria parcial ante la comisión de regulación de EEUU (SEC) y animó a inversores a seguir invirtiendo. Los informes públicos disponibles señalan que:
...
Por pultimo, la tecnología de Solana también ha sido utilizada en proyectos más allá de las finanzas y el juego, como la exploración espacial y la investigación científica. Por ejemplo, Pyth Network, en colaboración con la Bolsa de Valores de Londres, utiliza la red Solana para proporcionar datos financieros en tiempo real, entre otros multiples usos.
